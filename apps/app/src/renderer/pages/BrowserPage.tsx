...
observer.observe(document.body, {
  ...
  attributes: true,
      ...
      let isEnabledHoverHighlight = false;

      // Function to handle mouseover events for hover highlight
      function handleElementHover(e) {
        if (!isEnabledHoverHighlight) return;
    ...
    const handleLabelRegisterClick = async () => {
      ...
      `;
            // TODO: ラベル登録を押下した時にホバーでボーダーを表示するようにする
            await webviewRef.current.executeJavaScript(`isEnabledHoverHighlight = false;`)
        ...
        <div className="flex flex-col h-screen">
            ...
            <div className="flex flex-1 overflow-hidden h-[calc(100vh-60px)]">
                <webview
                    ...
                    className="flex-[2] relative h-full webview"
                    ref={webviewRef}
                    src={url}
                    allowpopups={true}
